...
CLOSED_POS = -0.010   # The position for a fully-closed gripper (meters).
OPENED_POS = 0.02  # The position for a fully-open gripper (meters).
ACTION_SERVER = 'gripper_controller/command'
